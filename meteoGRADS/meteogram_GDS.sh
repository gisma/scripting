#!/home/creu/progs/opengrads/Contents/Resources/Scripts/gradsm
* * * * * * * * * * * * *
* * * * * * * * * * * * 
* meteogram_GDS.gs
* 
...
if (print)
  'printim  'fn'_meteogram.png x1980 y1980'
endif
