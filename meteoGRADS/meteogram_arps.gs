...
* Open the data file
'reinit'
_baseurl = '/home/creu/progs/opengrads/data'
_dataset = 'waku203_2700_ARP.gradscntl'
*'sdfopen '_baseurl%_dataset
'open /home/creu/progs/opengrads/data/waku203_2700_ARP.gradscntl'
if (rc) ; return ; endif
...
dt = 6
if (units = 'e')
  'set string 1 l 4 90' ; 'draw string .85 0.4 'dt'hr Precip (in)'
else
  'set string 1 l 4 90' ; 'draw string .85 0.4 'dt'hr Precip (mm)'
endif
