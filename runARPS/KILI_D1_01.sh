...
# version 2015/05/23
# Setup file for an arbitrary ARPS-run
# FIXME
...
# by default all data in the current destination folder will be deleted
clean=true
...
# get actual  or individual date
source /home/$USER/$ARPSINPUTDIR/$DOMAIN/$SRC/date.input
...
export TBG_DMPIN=$TBG_DMPIN
export TINT_DMPIN=$TINT_DMPIN
export CMNT1=$CMNT1
export CMNT2=$CMNT2
export CMNT3=$CMNT3
export ARP=$ARP
...
export clean=$clean
export SRC=$SRC
export ARPSINDIR=$ARPSINPUTDIR
export ARPSINPUTDIR=$ARPSINPUTDIR
...
fn0=$(basename "$0")
cp  /home/$USER/$ARPSINPUTDIR/$DOMAIN/$SRC/$fn0 /home/$USER/run_$ARPS/$INITIALSTRING/$NAMESTRING/$fn0
